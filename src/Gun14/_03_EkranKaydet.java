...
public class _03_EkranKaydet extends BaseDriver {
    ...
    public void Test1() throws IOException {
        ...
        if (errorMsg.size() > 0){
            ...
            File hafizadakiFile = ts.getScreenshotAs(OutputType.FILE); // ekran kaydını Dosya formatı olarak hafızaya al
            ...
            // TODO : Öyle birşey yapınki her ekran kaydı, AYRI AYRI kaydedilsin.
        }
